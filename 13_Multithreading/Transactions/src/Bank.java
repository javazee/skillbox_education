...
public class Bank {
     ...
     * усмотрение)
     */
    public  void transfer(int fromAccountId, int toAccountId, long cashTransfer) throws InterruptedException {
        Account firstBlock;
        Account secondBlock;
        if(fromAccountId < toAccountId){
            firstBlock = accounts.get(fromAccountId);
            secondBlock = accounts.get(toAccountId);
        } else {
            firstBlock = accounts.get(toAccountId);
            secondBlock = accounts.get(fromAccountId);
        }
